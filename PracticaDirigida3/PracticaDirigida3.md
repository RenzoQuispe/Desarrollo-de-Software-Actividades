...
> Guarda cada bloque en su correspondiente archivo, dale permisos ![alt text](image.png)con `chmod +x` y adáptalo a tu repositorio.

#### Paso 1 – Abrir la terminal y verificar Bash
1. Abre tu **Terminal** en Linux/macOS o Git Bash en Windows.
![](imagenes_pasos/p1.1.png)  
2. Comprueba la versión de Bash:
![](imagenes_pasos/p1.2.png) 
3. Asegúrate de usar la cabecera portable en tus scripts:
![](imagenes_pasos/p1.3.png) 
...
4. Ejecútalo:
   ...
   ./hello.sh
   ```
![](imagenes_pasos/p2.4.png) 


#### Paso 3 – Asignación de variables
![](imagenes_pasos/p3.1.png) 
![](imagenes_pasos/p3.2.png) 
- Usa siempre comillas al expandir: `"$VAR"`.  
- Activa `set -u` para error si variable no definida.


#### Paso 4 – Parámetros posicionales
![](imagenes_pasos/p4.1.png) 
Ejecucion:
![](imagenes_pasos/p4.2.png) 


#### Paso 5 – Arrays en Bash
![](imagenes_pasos/p5.1.png) 
Ejecucion:
![](imagenes_pasos/p5.2.png) 


#### Paso 6 – Expansiones
#### Aritmética
![](imagenes_pasos/p6.1.png)
#### Substitución de comandos
![](imagenes_pasos/p6.2.png)
#### Otras
![](imagenes_pasos/p6.3.png)
...
#### if
![](imagenes_pasos/p8.1.png)

#### case
![](imagenes_pasos/p8.2.png)

#### Paso 9 – Bucles
![](imagenes_pasos/p9.1.png) 
Ejecucion:
![](imagenes_pasos/p9.2.png) 

#### Paso 10 – Funciones
![](imagenes_pasos/p10.1.png) 
Ejecucion:
![](imagenes_pasos/p10.2.png) 
